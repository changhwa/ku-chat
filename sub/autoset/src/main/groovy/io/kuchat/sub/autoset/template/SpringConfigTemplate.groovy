...
class SpringConfigTemplate implements Template{
    ...
    def template(options) {
        def jpaTemplate = this."$options.projectType"(options)
        jpaTemplate
    }
    ...
    def jpa(options){
        ...
        def projectKinds = options.projectKind
        def packageName = "io.kuchat.$projectKinds"+".config"
...
@EnableJpaRepositories("io.kuchat.$projectKinds")
@ComponentScan(basePackages = "io.kuchat.$projectKinds")
@Configuration
class AppConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("io.kuchat.$projectKinds.*")
